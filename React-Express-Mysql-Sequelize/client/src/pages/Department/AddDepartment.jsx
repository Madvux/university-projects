      ...
      <div className='flex flex-wrap justify-center content-center p-3'>
        ...
        <div className="flex flex-wrap justify-center min-h-screen content-center">
          <div className="w-full max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow-2xl sm:p-6 md:p-8 dark:bg-secondary-dark-bg dark:border-gray-700">
            ...
            <Form onSubmit={addDepartmentHandler} ref={form} className="space-y-6">
              <hr />
              <div className="mb-6">
              ...
              <button onClick={() => navigate("/departments")} className="w-full text-white bg-gray-600 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 text-center py-2.5 dark:hover:bg-gray-100 ">Wróć  </button>
